<script>
import ButtonLayout from '@/components/ButtonLayout/ButtonLayout.vue';
...
<template>
  <div class="heroContainer">
    <div class="leftColumnContent">
      ...
      <ButtonLayout @click="toggleHeader()" :class="'letsTalkButton'">
    ...
    <div class="rightColumnContent">
      <img
        class="personImage"
        src="https://images.unsplash.com/photo-1543269664-56d93c1b41a6?auto=format&fit=crop&q=60&w=800&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTU0fHxwZW9wbGV8ZW58MHx8MHx8fDA%3D"
        alt="Person Pic"
      />
    </div>
  </div>
