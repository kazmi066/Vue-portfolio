...
const projects = [
{
    ...
    },
    {
        ...
        description: "The Restaurant Landing Page is a responsive and feature-rich web presence solution for eateries. It's built using React.js and stylized with Bootstrap to deliver an attractive online front for restaurants of all sizes. This landing page offers not just a glimpse of the restaurant's delicious offerings but also facilitates online reservations and takeout orders. With dynamic menus, eye-catching food photography, and a user-friendly interface, it's a gateway to the world of culinary delights. Restaurants looking to expand their online presence and attract more diners can rely on this landing page to make a savory impression.",
        link: "https://www.google.com",
